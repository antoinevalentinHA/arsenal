...
- **Motif.** Le bouton est **au plus près de l'amorce qu'il prolonge** (statut + complétude) ; il rend la promotion « coup d'œil → page dédiée » **explicite et contextuelle**, là où un badge de tête n'apporte qu'un raccourci redondant.
...
- **Extension du patron aux vannes *(2026-07-16, même geste)*.** Le sous-diagnostic **vannes thermostatiques** suit désormais la même logique : une **amorce** est créée au hub (verdict global `sensor.vannes_thermostatiques_stabilite_globale` — pire cas de variance 12h sur les pièces, décidé **au backend**), prolongée par un **bouton contextuel** « Ouvrir le diagnostic » vers `diagnostics-vannes-dashboard`, et son **badge de tête est retiré**. Contrairement à la courbe (dont l'amorce préexistait), l'amorce vannes n'existait pas : elle est **créée** pour justifier le bouton (une amorce vannes globale manquait — le diagnostic vannes est par pièce, sans coup d'œil d'ensemble).
- **Extension du patron aux thermiques — série close *(2026-07-16)*.** Le dernier sous-diagnostic, **diagnostics thermiques**, suit le même geste : amorce créée au hub (verdict de tête `sensor.diagnostic_chauffage_thermique_synthese` — pire cas sur les 4 axes régulation / reprise / inertie / stabilité, décidé **au backend** ; distinct de « État global » qui porte la raison courante), bouton contextuel « Ouvrir le diagnostic » vers `diagnostics-thermiques-dashboard`, **badge de tête retiré**. **État final du hub** : les badges de tête sont désormais **purement structurels** (Accueil · Navigation · Retour) ; les **trois** sous-diagnostics (courbe, vannes, thermiques) sont promus par **amorce + bouton contextuel**, plus aucun badge de sous-diagnostic. L'homogénéité est **rétablie** (les trois suivent le même patron).
