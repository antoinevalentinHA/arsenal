...
| **Domaine** | VMC. |
| **Statut** | **Ouvert — Lots 1, 2c et 3 intégrés ; L2a acquis.** `vmc.md` **v2.1** est normatif dans `main` et le dispositif de preuve est défini par [`protocole_dispositif_preuve_vmc.md`](protocole_dispositif_preuve_vmc.md). **Arbitrage propriétaire (2026-07-21)** : l'effet réel de la haute vitesse est **acquis par la connaissance d'usage** ; la **mesure du débit et toute identification matérielle du moteur sortent du dispositif**. **L4 est recentré sur la seule observabilité** (corroboration de la haute vitesse). Aucune calibration n'est acquise. Aucun runtime, UI ni checker modifié. |
...
| **Prochain jalon** | **L4 — audit des moyens d'observation** (§5), recentré sur la corroboration de la haute vitesse ; **aucune mesure matérielle**. **L2b (calibration finale) reste ordonnancé après L5** ; **aucune correction runtime n'est autorisée tant que la séquence probatoire et L2b ne sont pas soldées**. |
...
| **L4** | **Audit des moyens d'observation** — corroboration de la haute vitesse (R6 : décision et relais non historisés) | Conclut : moyens suffisants / exposition diagnostique minimale. **Aucune mesure matérielle, aucune identification du moteur** (arbitrage 2026-07-21). `arsenal-runtime` déjà audité au L3 |
