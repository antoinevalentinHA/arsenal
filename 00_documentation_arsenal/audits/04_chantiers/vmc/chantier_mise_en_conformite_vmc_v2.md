...
| **6** | `sensor.vmc_intention` calcule sa cause sur `delta_humidite_absolue > 0`, approximation de lisibilité **susceptible de diverger** de la décision réelle — le fichier l'annonce lui-même | §11.2 (v2.2) |

> **L'écart n° 6 est relevé par L6** ([`analyse_impact_runtime_vmc.md`](analyse_impact_runtime_vmc.md)
> §6). Il est **antérieur au chantier**, **déjà** non conforme au contrat en
> vigueur, et n'était rattaché à aucun lot : il motive la proposition d'un
> **L7.7**.
