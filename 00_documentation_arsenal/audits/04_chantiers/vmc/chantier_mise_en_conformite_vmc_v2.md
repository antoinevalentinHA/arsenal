...
| [`contrats/vmc.md`](../../../contrats/vmc.md) **v2.3** | **Contrat normatif opposable.** v2.0 au Lot 1, amendé en **v2.1** au Lot 2c (§2.2 bis, §4.4 bis, §9.1 bis), en **v2.2** au lot de clarification du modulateur (§6.4, **§7.4 bis**, §10.2, §12.3, §14.3), puis en **v2.3** à L7.4 (**§9.1 ter** — reconstitution de la fenêtre glissante depuis l'historique enregistré, §9.1 bis, §12.3) |
...
> §14, §15.1…) du présent document pointent vers `contrats/vmc.md` **v2.3**,
> normatif dans `main`.
...
| **5** ⚠️ | Aucune restauration ni gestion d'indisponibilité conformes — **partiellement résorbé (2026-07-22, L7.5)** : §9.1 cas 1 à 4 **appliqués** et §4.4 **construit et exposé**, mais **l'exposabilité du cas 4 (§10.2 exigence 10) N'EST PAS SERVIE** — un `input_boolean` sans état restaurable apparaît à `off`, jamais à `unknown`/`unavailable` (**0 sur 21 964 lignes**, `arsenal-runtime` `704a056`) : le cas 4 **n'est pas détectable** avec ce porteur | §9.1, §4.4, §10.2 |
...
| Dépendance | Nature |
|---|---|
| [`contrats/vmc.md`](../../../contrats/vmc.md) **v2.3** | **Autorité.** Contrat normatif — v2.0 au Lot 1, v2.1 au Lot 2c, v2.2 au lot de clarification du modulateur, **v2.3** à L7.4 |
