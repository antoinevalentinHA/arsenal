...
| ~~2~~ ✅ | ~~Frontières de libération définies mais non consommées~~ **résorbé (2026-07-22, L7.4)** — frontière modulée calculée, consommée et exposée | §6.4, §6.6, §10.4 |
| ~~3~~ ✅ | ~~Aucun besoin hystérétique — comparateur à frontière unique~~ **résorbé (2026-07-22, L7.4)** — entrée et libération distinctes, état porté par un `input_boolean` | §2.2, §6 |
