...
- **Statut :** point d’étape consolidé — **2 points P1 traités**, **3 P2 traités** (`sante/sommeil.md`, `meteo/fallback.md`, `meteo/extrema_jour_courant.md`), **1 divergence fermée** ; chantier **toujours ouvert** (P2–P4 restants).
...
> Les deux P1 de l’audit (`05_capteurs_parametrage_canonique.md` vide, `reveils`/`babyphone` non documenté) sont traités ; P2 traités : `sante/sommeil.md` (v1.0), `meteo/fallback.md` (v1.0) et `meteo/extrema_jour_courant.md` (v1.0). L’ordre restant ne comporte plus de P1 ; les P2 restants sont des **domaines à documenter** (`electromenager`, `poele`).
