...
- **Statut :** point d’étape consolidé — **2 points P1 traités**, **1 divergence fermée** ; chantier **toujours ouvert** (P2–P4 restants).
...
1. **P2 — contrats draft à figer :** `sante/sommeil.md` (→ v1.0), `meteo/extrema_jour_courant.md` (→ v1.0), `meteo/fallback.md` (consolider / fusionner).
...
> Les deux P1 de l’audit (`05_capteurs_parametrage_canonique.md` vide, `reveils`/`babyphone` non documenté) sont traités. L’ordre restant ne comporte plus de P1.
