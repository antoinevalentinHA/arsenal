...
| **C7** | Centralisation des palmarès météo (dashboard « Palmarès météo ») | lovelace / météo | **P2** | cadré — arbitrages tranchés (Q1–Q10), prêt à exécuter ; aucun fichier runtime/doc modifié | Exécuter Lot 1 (note `navigation/domaines/meteo.md`) → Lot 2 (créer `meteo-palmares-dashboard`, recâbler, **gate responsive bandeau** sinon badge `mdi:trophy`) → Lot 3 (3 checkers + rendu) → Lot 4 (changelog / clôture) | [`04_chantiers/lovelace/cadrage_palmares_meteo.md`](04_chantiers/lovelace/cadrage_palmares_meteo.md) |
