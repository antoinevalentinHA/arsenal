...
| **C10** | Arrosage — V1 automatique & découvrabilité du domaine | arrosage | P2 | observation v0 réservoir sol livrée (#103) ; supervision batteries/LQI sondes sol livrée (#104/#105/#106) ; contrat 12 réaligné (#107) ; statuts runtime observation réalignés (#108) — **V1 automatique (décision/action) livrée** (contrat 17 #121, runtime mono-station + coexistence `rain_delay` #125) | Poursuivre la **découvrabilité documentaire** (hub navigation + `carte_domaines`, changelog rétroactif, liens contrat↔runtime) et l'**observation terrain** du canal sol ; **calibration par l'observation** (modulateurs) comme chantier ultérieur | [`../contrats/arrosage/README.md`](../contrats/arrosage/README.md) |
