...
| **C10** | Arrosage — observation v0 & découvrabilité du domaine | arrosage | P2 | observation v0 réservoir sol livrée (#103) ; supervision batteries/LQI sondes sol livrée (#104/#105/#106) ; contrat 12 réaligné (#107) ; statuts runtime observation réalignés (#108) — **décision/action arrosage toujours pré-runtime** | Poursuivre la **découvrabilité documentaire** (hub navigation + `carte_domaines`, changelog rétroactif, liens contrat↔runtime) et l'**observation terrain** du canal sol ; **aucune ouverture runtime décision/action** | [`../contrats/arrosage/README.md`](../contrats/arrosage/README.md) |
