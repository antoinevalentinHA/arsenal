...
| **H1** | Déshumidificateur — seuils potentiellement inversés | climatisation | **P0-cond** | latent (runtime sain ce jour) | Vérifier `cave_rh_cible_on/off` ; ajouter `initial` + resserrer les plages (action ~30 s) | [`04_chantiers/climatisation/backlog_climatisation_hysteresis.md`](04_chantiers/climatisation/backlog_climatisation_hysteresis.md) |
