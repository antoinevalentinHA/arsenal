...
| Dossier | Fichiers | Contenu |
|---|:--:|---|
| [03_doctrines/](./03_doctrines/) | 14 | **Bibliothèque doctrinale fondamentale** : nommage, causalité, gestion du temps, séparation décision/action, git, principes généraux, IDs d'automatisations, contrat préfixe ↔ domaine, solvabilité probatoire et autorité de domaine (voir note) |
