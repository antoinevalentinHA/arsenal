...
- Présence confort thermique stabilisée — suivi post-déploiement (**implémenté V1+V2, sous observation, en attente de validation terrain**) — [`suivi_post_deploiement_presence_confort_thermique_stabilisee.md`](../../audits/04_chantiers/climatisation/suivi_post_deploiement_presence_confort_thermique_stabilisee.md)
