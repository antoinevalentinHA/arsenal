...
- Stabilisation présence confort thermique (interface COOL/DRY clim) — [`cadrage_contrat_presence_confort_thermique_stabilisee.md`](../../audits/02_conception/climatisation/cadrage_contrat_presence_confort_thermique_stabilisee.md) — **validé terrain (volet A, COOL/DRY) le 2026-06-19** (clôture [`cloture_presence_confort_thermique_stabilisee.md`](../../audits/05_clotures/climatisation/cloture_presence_confort_thermique_stabilisee.md)) ; **ratification du contrat comme opposable : acte distinct, non emporté par la validation terrain** ; signal dérivé de `presence_famille_unifiee`, confiné aux décisions COOL/DRY ; tenue : [`note_calibration_tenue_T`](../../audits/02_conception/climatisation/note_calibration_tenue_T_presence_confort_thermique.md) (**T = 120 s ratifié, réserve de surveillance ~13 s**) ; périmètre : [`inventaire_consommateurs`](../../audits/02_conception/climatisation/inventaire_consommateurs_presence_famille_unifiee.md) ; suivi : [`suivi_post_deploiement`](../../audits/04_chantiers/climatisation/suivi_post_deploiement_presence_confort_thermique_stabilisee.md).
