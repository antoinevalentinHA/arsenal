# ==========================================================
#  🧠 ARSENAL — CHANGELOG
#  Fichier : 00_documentation_arsenal/changelog/changelogs/v10/v10_pre v11.md
# ==========================================================
...
`00_documentation_arsenal/evolutions_futures/viessmann_local/`
...
`11_automations/poele/activation_memoire_24h.yaml`
...
`00_documentation_arsenal/contrats/chauffage/75_auto_ajustement_courbe.md`
...
`12_template_sensors/chauffage/mode.yaml`
...
`10_scripts/aeration/00_reset_manuel.yaml`
...
`10_scripts/system/notifications_mobiles.yaml`
