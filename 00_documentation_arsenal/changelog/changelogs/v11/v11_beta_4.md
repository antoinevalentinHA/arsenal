...
Suppressions : `11_automations/ecs/signal_fin_cycle.yaml`, `11_automations/ecs/log/fin.yaml`, `00_documentation_arsenal/contrats/ecs/10_resilience_et_defaillances.md` (remplacé par un dossier).
