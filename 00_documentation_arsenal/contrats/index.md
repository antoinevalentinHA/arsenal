...
| [arrosage/](./arrosage/) | 12 | README ✅ | Arrosage jardin — coexistence gouvernée Arsenal ↔ Rain Bird (v0.1, pré-runtime) + relevé pont MQTT, classification entités, pré-requis runtime, mode manuel supervisé |
