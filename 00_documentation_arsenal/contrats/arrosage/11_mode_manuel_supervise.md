...
`[1,60]`, puis appliquée à `number.…_station_1_duration` avant ouverture.

| Observation | Valeur |
|---|---|
| Durée réglée via le helper | **1 min** (borne basse `[1,60]`) |
...
- La **chaîne de durée paramétrable** (helper borné → clamp `[1,60]` →
