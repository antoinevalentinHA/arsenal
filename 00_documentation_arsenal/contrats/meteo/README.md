...
| [`tendance_temperature.md`](tendance_temperature.md) | Tendance thermique (hausse/baisse/stable) des agrégats intérieurs — restitution Android Auto. **v1.2 (révision)** : grandeur de décision v1.1 conforme au runtime (`moyenne_courte − moyenne_longue`) ; architecture amendée par l'ajout d'une couche de projection statistique ré-échantillonnée (§4.2), **désormais déployée et validée terrain** (PR #839, §19) ; validation terrain des seuils (§8.2) reste en dette ouverte, distincte. Voir l'audit fondateur : [`audit_tendance_temperature_sensibilite.md`](../../audits/01_rapports/meteo/audit_tendance_temperature_sensibilite.md) |
