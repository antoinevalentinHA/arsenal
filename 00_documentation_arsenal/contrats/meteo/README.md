...
| [`tendance_temperature.md`](tendance_temperature.md) | Tendance thermique (hausse/baisse/stable) des agrégats intérieurs — restitution Android Auto. **v1.1 (révision)** : grandeur de décision amendée (`moyenne_courte − moyenne_longue`), runtime conforme ; validation terrain des seuils (§8.2) en dette ouverte. Voir l'audit fondateur : [`audit_tendance_temperature_sensibilite.md`](../../audits/01_rapports/meteo/audit_tendance_temperature_sensibilite.md) |
