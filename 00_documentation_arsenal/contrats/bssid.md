...
|----------------------|-------------------|
| `sensor.telephone_parent_1_bssid_dynamic` | `person.parent_1` |
| `sensor.telephone_parent_2_bssid_dynamic` | `person.parent_2` |
...
| `candidats_parent_1` | `string` | CSV des BSSID candidats issus de `sensor.telephone_parent_1_bssid_dynamic`, uniquement si `person.parent_1` est dans `'Maison securite'`. Chaîne vide sinon. |
| `candidats_parent_2` | `string` | CSV des BSSID candidats issus de `sensor.telephone_parent_2_bssid_dynamic`, uniquement si `person.parent_2` est dans `'Maison securite'`. Chaîne vide sinon. |
| `sources_eligibles` | `string` | CSV des sources actuellement éligibles : `parent_1`, `parent_2`. |
| `sources_inertes` | `string` | CSV des sources actuellement inertes : `parent_1`, `parent_2`. |

**Règles** :

- les attributs sont recalculés à chaque évaluation du sensor
- `candidats` est l'union de `candidats_parent_1` et `candidats_parent_2`
- aucune source non éligible ne contribue à `candidats`, `candidats_parent_1` ou `candidats_parent_2`
...
|--------|------------------|------|
| `sensor.telephone_parent_1_bssid_dynamic` | `person.parent_1` | BSSID actuel du téléphone de Parent 1 — abstraction stable sur `input_text.telephone_parent_1_wifi_bssid` |
| `sensor.telephone_parent_2_bssid_dynamic` | `person.parent_2` | BSSID actuel du téléphone de Parent 2 — abstraction stable sur `input_text.telephone_parent_2_wifi_bssid` |
...
| Entité | Rôle |
|--------|------|
| `person.parent_1` | Parent 1 — sa présence dans `'Maison securite'` conditionne l'éligibilité de `sensor.telephone_parent_1_bssid_dynamic` |
| `person.parent_2` | Parent 2 — sa présence dans `'Maison securite'` conditionne l'éligibilité de `sensor.telephone_parent_2_bssid_dynamic` |
