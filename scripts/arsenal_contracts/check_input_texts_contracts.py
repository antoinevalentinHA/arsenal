#!/usr/bin/env python3
"""
Arsenal — Validation contractuelle : Structure — 04_input_texts
Contrat (source normative) : 00_documentation_arsenal/architecture/00_structure_includes/04_input_texts.md
"""
...
INPUT_TEXTS_DIR = ROOT / "04_input_texts"
