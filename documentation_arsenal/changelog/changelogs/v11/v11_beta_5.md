...
Ajout de `counter: !include_dir_merge_named 08b_counters` dans `configuration.yaml`. Le dossier `08b_counters` est désormais déclaré comme source de counters HA natifs.

Nouveau compteur introduit :

- `counter.clim_execution_retry_count` (`08b_counters/clim_execution_retry_count.yaml`)

Nouveau document : `documentation_arsenal/architecture/structure_includes/08_b_counters.md`
...
- `script.clim_exec_apply_cool` (`09_scripts/climatisation/cool.yaml`)
- `script.clim_exec_apply_dry` (`09_scripts/climatisation/dry.yaml`)
- `script.clim_exec_apply_heat` (`09_scripts/climatisation/heat.yaml`)
- `script.clim_exec_apply_off` (`09_scripts/climatisation/off.yaml`)
...
`10_automations/climatisation/notification.yaml` supprimé, remplacé par `notifications.yaml`. Mise en conformité avec les conventions de nommage Arsenal.
...
- `10_automations/chauffage/representativite_thermique.yaml` — automation associée
...
- `11_template_sensors/eclairage/garage_estimation_etat.yaml` — sensor d'estimation d'état
- `10_automations/eclairage/garage/recalage_nocturne_booleen.yaml` — recalage nocturne du booléen d'état logique
- `documentation_arsenal/contrats/eclairage/recalage_nocturne_garage.md` — contrat associé

### `documentation_arsenal/contrats/eclairage/garage.md` — Recentrage sur le contrat d'implémentation
...
### `documentation_arsenal/architecture/logbook.md` — Passage en contrat opposable
...
### `documentation_arsenal/architecture/recorder.md` — Passage en contrat opposable
...
`documentation_arsenal/changelog/changelogs/v11/v11_beta_4.md` — ajout du changelog v11 beta 4 dans les archives.
