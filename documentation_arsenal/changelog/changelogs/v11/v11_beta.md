...
| `10_automations/system/reload_integrations/vicare.yaml` | Automation de rechargement ViCare |
| `10_automations/vicare/alerte_gateway_offline.yaml` | Alerte gateway ViCare hors ligne |
| `10_automations/vicare/ko.yaml` | Automation état KO ViCare |
| `10_automations/vicare/ok.yaml` | Automation retour OK ViCare |
| `11_template_sensors/vicare/api_disponible.yaml` | Capteur disponibilité API ViCare |
| `11_template_sensors/vicare/gateway_offline.yaml` | Capteur gateway offline ViCare |
| `11_template_sensors/vicare/temperature_chaudiere.yaml` | Capteur température chaudière ViCare |
...
| Fichier supprimé | Description |
|---|---|
| `09_scripts/chauffage/consignes/confort.yaml` | Script application consigne confort |
| `09_scripts/chauffage/consignes/reduit.yaml` | Script application consigne réduit |
| `09_scripts/chauffage/synchro_consignes/confort.yaml` | Script synchro consigne confort |
| `09_scripts/chauffage/synchro_consignes/reduit.yaml` | Script synchro consigne réduit |
| `10_automations/chauffage/realignement_consignes.yaml` | Automation réalignement consignes |
| `10_automations/chauffage/syncho_consignes/confort.yaml` | Automation synchro consigne confort |
| `10_automations/chauffage/syncho_consignes/reduit.yaml` | Automation synchro consigne réduit |
| `11_template_sensors/chauffage/consignes/confort.yaml` | Capteur consigne confort (cloud) |
| `11_template_sensors/chauffage/consignes/reduite.yaml` | Capteur consigne réduite (cloud) |
| `11_template_sensors/chauffage/consignes/effective.yaml` | Capteur consigne effective (cloud) |
| `11_template_sensors/chauffage/incoherence/consignes.yaml` | Capteur incohérence consignes (cloud) |
...
`09_scripts/chauffage/application_consigne.yaml`
...
|---|---|
| `11_template_sensors/boiler/boiler_ack_dhw_set_setpoint_transaction.yaml` | ECS — setpoint |
| `11_template_sensors/boiler/boiler_ack_heating_set_temperature_transaction.yaml` | Chauffage — température consigne |
| `11_template_sensors/boiler/boiler_ack_heating_set_curve_slope_transaction.yaml` | Courbe de chauffe — pente |
| `11_template_sensors/boiler/boiler_ack_heating_set_curve_shift_transaction.yaml` | Courbe de chauffe — parallèle |
...
`11_template_sensors/boiler/boiler_bridge_heartbeat.yaml`
...
Le `binary_sensor.boiler_bridge_heartbeat` (expire_after) est supprimé de `mqtt_binary_sensors/boiler/boiler_bridge.yaml`. 
`sensor.boiler_bridge_heartbeat_raw` est ajouté dans `mqtt_sensors/boiler/boiler_bridge.yaml` comme source MQTT brute.
...
| Fichier | Description |
|---|---|
| `documentation_arsenal/changelog/changelogs/v10/v10 final.md` | Changelog v10 finale |
| `documentation_arsenal/changelog/changelogs/v10/v10_pre_v11.md` | Changelog pré-v11 |
| `documentation_arsenal/contrats/boiler/consommation_ack_heating_set_comfort.md` | Contrat ACK heating set comfort |
| `documentation_arsenal/contrats/boiler/consommation_ack_heating_set_program.md` | Contrat ACK heating set program |
| `documentation_arsenal/evolutions_futures/viessmann_local/mi_etape.md` | Document mi-étape migration locale |
...
`10_automations/chauffage/realignement_vicare_ha.yaml`
...
`11_template_sensors/chauffage/programme.yaml`
...
`11_template_sensors/ecs/chauffe_en_cours.yaml`
...
`11_template_sensors/ecs/temperature.yaml`
...
`mqtt_sensors/boiler/boiler_command_feedback.yaml`
