...
Nouveau dossier `documentation_arsenal/ui/couleurs/` (6 fichiers) :
...
- `11_template_sensors/boiler/boiler_bridge_degraded.yaml`
  (remplace `vicare/boiler_bridge_degraded.yaml`)
- `11_template_sensors/boiler/boiler_command_feedback.yaml`
- Ajout d'un sensor dans `mqtt_sensors/`

### 2.6 Capteur alarme ouvrants entrée

`11_template_sensors/alarme/ouvrants_entree.yaml` — signal métier dédié
...
- `documentation_arsenal/contrats/climatisation.md`
- `documentation_arsenal/contrats/meteo.md` + `meteo_affichage.md`
- `documentation_arsenal/evolutions_futures/viessmann_local.md`
- `documentation_arsenal/ui/couleurs.md`
- `documentation_arsenal/outils_externes/chat_gpt/` (purge complète)
- `documentation_arsenal/outils_externes/gemini/reglages_chauffage.md`