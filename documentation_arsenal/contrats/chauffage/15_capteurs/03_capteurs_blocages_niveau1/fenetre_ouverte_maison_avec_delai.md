...
- `11_template_sensors/chauffage/diagnostic/raison.yaml` — diagnostic de raison chauffage
- `11_template_sensors/aeration/coherence.yaml` — capteur de cohérence aération
