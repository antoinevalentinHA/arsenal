...
- Chemin : `homeassistant/documentation_arsenal/contrats/alarme/51_ouvrants_entree_alarme.md`
...
```
/homeassistant/documentation_arsenal/contrats/ouvertures_redondance.md
```
