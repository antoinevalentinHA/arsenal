...
**Domaine consommateur** : Infrastructure technique uniquement. Ne produit qu'un signal
d'approche — ne déclenche aucune décision métier finale.
...
```bash
grep -r "zone.home" 10_automations/ 11_template_sensors/ 09_scripts/ 12_sensor_platforms/ 01_customize/
```
